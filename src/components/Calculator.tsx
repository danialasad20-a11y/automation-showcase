      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="calc-card bg-card rounded-2xl border border-border p-8 md:p-12 shadow-soft">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="font-semibold text-lg text-foreground">Estimate Your Savings</span>
          </div>
            ...
            {result && (
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                  ...
                  <div key={r.label} className="text-center p-5 rounded-xl bg-secondary border border-border">
