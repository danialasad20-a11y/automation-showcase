      ...
      <div className="flex items-center justify-center gap-6 mb-14">
        {socials.map((s) => (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={`w-14 h-14 rounded-xl border border-border bg-background flex items-center justify-center text-muted-foreground ${s.color} hover:border-primary/40 hover:scale-110 transition-all duration-300`}
            aria-label={s.name}
          >
            {s.icon}
          </a>
